...
description: Getting started with a local deployment of the biocentral_server.
---
...
```shell
git clone https://github.com/biocentral/biocentral.git
cd biocentral/biocentral_server
```
