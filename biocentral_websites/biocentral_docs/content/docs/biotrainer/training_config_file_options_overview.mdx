---
title: Config Options - Overview
description: An overview of all configuration options available in biotrainer.
icon: Cog
---

Here, you can find an overview about all configuration options available in *biotrainer*.
For more details, please refer to the descriptions in [config_file_options](./config_file_options.mdx).
