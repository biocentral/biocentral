...
from biocentral_api import BiocentralAPI, BiotrainerModelResult, BiotrainerInferenceResult, \
    Prediction, BiocentralPredictionModel, SequenceData, ProjectionResult
...
class APIBackend:
    ...
    def embed(self,
        ...
        task = self._api.embed(embedder_name, sequence_data, reduce=reduce,
    ...
    def project(self,
        ...
        task = self._api.project(embedder_name, method, sequence_data, projection_config)
        return task.run()
