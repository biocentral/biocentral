...
class BiocentralServiceApi {
  ...
  Future<Response<ResearchStatsResponse>> researchStatsApiV1BiocentralServiceResearchStatsGet({ 
    ...
    final _path = r'/api/v1/biocentral_service/research_stats/';
    ...
    ResearchStatsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ResearchStatsResponse),
      ) as ResearchStatsResponse;
    ...
    return Response<ResearchStatsResponse>(
      data: _responseData,
  ...
  Future<Response<ServiceStatsResponse>> statsApiV1BiocentralServiceStatsGet({ 
    ...
    final _path = r'/api/v1/biocentral_service/stats/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ServiceStatsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ServiceStatsResponse),
    ...
    return Response<ServiceStatsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<TaskStatusResponse>> taskStatusApiV1BiocentralServiceTaskStatusTaskIdGet({ 
    ...
    final _path = r'/api/v1/biocentral_service/task_status/{task_id}'.replaceAll('{' r'task_id' '}', encodeQueryParameter(_serializers, taskId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<TaskStatusResponse>> taskStatusResumedApiV1BiocentralServiceTaskStatusResumedTaskIdGet({ 
    ...
    final _path = r'/api/v1/biocentral_service/task_status_resumed/{task_id}'.replaceAll('{' r'task_id' '}', encodeQueryParameter(_serializers, taskId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> welcomeMessageApiV1BiocentralServiceWelcomeMessageGet({ 
    ...
    final _path = r'/api/v1/biocentral_service/welcome_message';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
