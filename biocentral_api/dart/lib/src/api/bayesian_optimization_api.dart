...
class BayesianOptimizationApi {

  final Dio _dio;

  final Serializers _serializers;

  const BayesianOptimizationApi(this._dio, this._serializers);
  ...
  Future<Response<StartTaskResponse>> trainAndInferenceApiV1BayesianOptimizationServiceTrainingPost({ 
    required BayesianOptimizationRequest bayesianOptimizationRequest,
    ...
    final _path = r'/api/v1/bayesian_optimization_service/training';
    ...
    try {
      const _type = FullType(BayesianOptimizationRequest);
      _bodyData = _serializers.serialize(bayesianOptimizationRequest, specifiedType: _type);
