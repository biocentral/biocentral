...
class ProjectionsApi {
  ...
  const ProjectionsApi(this._dio, this._serializers);
  ...
  Future<Response<StartTaskResponse>> projectApiV1ProjectionServiceProjectPost({ 
    ...
    final _path = r'/api/v1/projection_service/project';
    ...
    try {
      const _type = FullType(ProjectionRequest);
      _bodyData = _serializers.serialize(projectionRequest, specifiedType: _type);
  ...
  Future<Response<GetProjectionConfigResponse>> projectionConfigApiV1ProjectionServiceProjectionConfigGet({ 
    ...
    final _path = r'/api/v1/projection_service/projection_config';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetProjectionConfigResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetProjectionConfigResponse),
      ) as GetProjectionConfigResponse;
    ...
    return Response<GetProjectionConfigResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
