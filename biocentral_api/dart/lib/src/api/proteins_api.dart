...
class ProteinsApi {
  ...
  const ProteinsApi(this._dio, this._serializers);
  ...
  Future<Response<TaxonomyResponse>> taxonomyApiV1ProteinServiceTaxonomyPost({
    ...
    final _path = r'/api/v1/protein_service/taxonomy/';
    ...
    try {
      const _type = FullType(TaxonomyRequest);
      _bodyData = _serializers.serialize(taxonomyRequest, specifiedType: _type);
    ...
    TaxonomyResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TaxonomyResponse),
      ) as TaxonomyResponse;
    ...
    return Response<TaxonomyResponse>(
      data: _responseData,
  ...
  Future<Response<StartTaskResponse>> triggerProteinClusteringApiV1ProteinServiceClusterPost({
    ...
    final _path = r'/api/v1/protein_service/cluster/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ClusteringRequest);
      _bodyData = _serializers.serialize(clusteringRequest, specifiedType: _type);
