...
class PpiApi {
  ...
  Future<Response<DetectedFormatResponse>> autoDetectFormatByHeaderApiV1PpiServiceAutoDetectFormatPost({ 
    ...
    final _path = r'/api/v1/ppi_service/auto_detect_format';
    ...
    try {
      const _type = FullType(AutoDetectFormatRequest);
      _bodyData = _serializers.serialize(autoDetectFormatRequest, specifiedType: _type);
    ...
    DetectedFormatResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DetectedFormatResponse),
      ) as DetectedFormatResponse;
    ...
    return Response<DetectedFormatResponse>(
      data: _responseData,
  ...
  Future<Response<JsonObject>> formatsApiV1PpiServiceFormatsGet({ 
    ...
    final _path = r'/api/v1/ppi_service/formats';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ImportDatasetResponse>> importDatasetApiV1PpiServiceImportPost({ 
    ...
    final _path = r'/api/v1/ppi_service/import';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ImportDatasetRequest);
      _bodyData = _serializers.serialize(importDatasetRequest, specifiedType: _type);
    ...
    ImportDatasetResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ImportDatasetResponse),
      ) as ImportDatasetResponse;
    ...
    return Response<ImportDatasetResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RunTestResponse>> runTestApiV1PpiServiceDatasetTestsRunTestPost({ 
    ...
    final _path = r'/api/v1/ppi_service/dataset_tests/run_test';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RunTestRequest);
      _bodyData = _serializers.serialize(runTestRequest, specifiedType: _type);
    ...
    RunTestResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RunTestResponse),
      ) as RunTestResponse;
    ...
    return Response<RunTestResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<JsonObject>> testsApiV1PpiServiceDatasetTestsTestsGet({ 
    ...
    final _path = r'/api/v1/ppi_service/dataset_tests/tests';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
