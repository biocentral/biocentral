...
class CustomModelsApi {
  ...
  const CustomModelsApi(this._dio, this._serializers);
  ...
  Future<Response<ConfigOptionsResponse>> configOptionsApiV1CustomModelsServiceConfigOptionsProtocolGet({ 
    ...
    final _path = r'/api/v1/custom_models_service/config_options/{protocol}'.replaceAll('{' r'protocol' '}', encodeQueryParameter(_serializers, protocol, const FullType(String)).toString());
    ...
    ConfigOptionsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConfigOptionsResponse),
      ) as ConfigOptionsResponse;
    ...
    return Response<ConfigOptionsResponse>(
      data: _responseData,
  ...
  Future<Response<BuiltMap<String, JsonObject>>> modelFilesApiV1CustomModelsServiceModelFilesPost({ 
    ...
    final _path = r'/api/v1/custom_models_service/model_files';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ModelFilesRequest);
      _bodyData = _serializers.serialize(modelFilesRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProtocolsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProtocolsResponse>> protocolsApiV1CustomModelsServiceProtocolsGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/custom_models_service/protocols';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ProtocolsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProtocolsResponse),
    ...
    return Response<ProtocolsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StartTaskResponse>> startInferenceApiV1CustomModelsServiceStartInferencePost({ 
    ...
    final _path = r'/api/v1/custom_models_service/start_inference';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(StartInferenceRequest);
      _bodyData = _serializers.serialize(startInferenceRequest, specifiedType: _type);
    ...
    StartTaskResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(StartTaskResponse),
    ...
    return Response<StartTaskResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StartTaskResponse>> startTrainingApiV1CustomModelsServiceStartTrainingPost({ 
    ...
    final _path = r'/api/v1/custom_models_service/start_training';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(StartTrainingRequest);
      _bodyData = _serializers.serialize(startTrainingRequest, specifiedType: _type);
  ...
  Future<Response<ConfigVerificationResponse>> verifyConfigApiV1CustomModelsServiceVerifyConfigPost({ 
    ...
    final _path = r'/api/v1/custom_models_service/verify_config/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ConfigVerificationRequest);
      _bodyData = _serializers.serialize(configVerificationRequest, specifiedType: _type);
    ...
    ConfigVerificationResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConfigVerificationResponse),
      ) as ConfigVerificationResponse;
    ...
    return Response<ConfigVerificationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
