...
class ActiveLearningApi {
  ...
  Future<Response<StartTaskResponse>> activeLearningEngineeringIterationApiV1ActiveLearningServiceEngineeringIterationPost({ 
    ...
    final _path = r'/api/v1/active_learning_service/engineering_iteration';
    ...
    try {
      const _type = FullType(ActiveLearningEngineeringIterationRequest);
      _bodyData = _serializers.serialize(activeLearningEngineeringIterationRequest, specifiedType: _type);
  ...
  Future<Response<StartTaskResponse>> activeLearningScreeningIterationApiV1ActiveLearningServiceScreeningIterationPost({ 
    ...
    final _path = r'/api/v1/active_learning_service/screening_iteration';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ActiveLearningScreeningIterationRequest);
      _bodyData = _serializers.serialize(activeLearningScreeningIterationRequest, specifiedType: _type);
  ...
  Future<Response<StartTaskResponse>> activeLearningScreeningSimulationApiV1ActiveLearningServiceScreeningSimulationPost({ 
    ...
    final _path = r'/api/v1/active_learning_service/screening_simulation';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ActiveLearningScreeningSimulationRequest);
      _bodyData = _serializers.serialize(activeLearningScreeningSimulationRequest, specifiedType: _type);
