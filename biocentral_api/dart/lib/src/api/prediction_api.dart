...
class PredictionApi {
  ...
  const PredictionApi(this._dio, this._serializers);
  ...
  Future<Response<ModelMetadataResponse>> modelMetadataApiV1PredictionServiceModelMetadataGet({ 
    ...
    final _path = r'/api/v1/prediction_service/model_metadata';
    ...
    ModelMetadataResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ModelMetadataResponse),
      ) as ModelMetadataResponse;
  ...
  Future<Response<StartTaskResponse>> predictApiV1PredictionServicePredictPost({ 
    ...
    final _path = r'/api/v1/prediction_service/predict';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PredictionRequest);
      _bodyData = _serializers.serialize(predictionRequest, specifiedType: _type);
