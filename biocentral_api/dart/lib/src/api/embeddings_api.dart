...
class EmbeddingsApi {
  ...
  Future<Response<AddEmbeddingsResponse>> addEmbeddingsApiV1EmbeddingsServiceAddEmbeddingsPost({ 
    ...
    final _path = r'/api/v1/embeddings_service/add_embeddings';
    ...
    try {
      const _type = FullType(AddEmbeddingsRequest);
      _bodyData = _serializers.serialize(addEmbeddingsRequest, specifiedType: _type);
    ...
    AddEmbeddingsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AddEmbeddingsResponse),
      ) as AddEmbeddingsResponse;
    ...
    return Response<AddEmbeddingsResponse>(
      data: _responseData,
  ...
  Future<Response<BuiltList<CommonEmbedder>>> commonEmbeddersApiV1EmbeddingsServiceCommonEmbeddersGet({ 
    ...
    final _path = r'/api/v1/embeddings_service/common_embedders';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<CommonEmbedder>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(CommonEmbedder)]),
      ) as BuiltList<CommonEmbedder>;
    ...
    return Response<BuiltList<CommonEmbedder>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<StartTaskResponse>> embedApiV1EmbeddingsServiceEmbedPost({ 
    ...
    final _path = r'/api/v1/embeddings_service/embed';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(EmbedRequest);
      _bodyData = _serializers.serialize(embedRequest, specifiedType: _type);
  ...
  Future<Response<GetMissingEmbeddingsResponse>> getMissingEmbeddingsApiV1EmbeddingsServiceGetMissingEmbeddingsPost({ 
    ...
    final _path = r'/api/v1/embeddings_service/get_missing_embeddings';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GetMissingEmbeddingsRequest);
      _bodyData = _serializers.serialize(getMissingEmbeddingsRequest, specifiedType: _type);
    ...
    GetMissingEmbeddingsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetMissingEmbeddingsResponse),
      ) as GetMissingEmbeddingsResponse;
    ...
    return Response<GetMissingEmbeddingsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
