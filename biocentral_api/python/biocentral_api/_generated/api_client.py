...
from biocentral_api._generated.configuration import Configuration
from biocentral_api._generated.api_response import ApiResponse, T as ApiResponseT
import biocentral_api._generated.models
from biocentral_api._generated import rest
from biocentral_api._generated.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def response_deserialize(
        ...
        if response_type is None and str(response_data.status) not in response_types_map \
                and (not isinstance(response_data.status, int) or not 100 <= response_data.status <= 599 or
                     str(response_data.status)[0] + "XX" not in response_types_map) \
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(biocentral_api._generated.models, klass)
