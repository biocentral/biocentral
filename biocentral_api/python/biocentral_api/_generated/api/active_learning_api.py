...
class ActiveLearningApi:
    ...
    def active_learning_engineering_iteration_api_v1_active_learning_service_engineering_iteration_post(
        ...
        :param active_learning_engineering_iteration_request: (required)
        :type active_learning_engineering_iteration_request: ActiveLearningEngineeringIterationRequest
    ...
    def _active_learning_engineering_iteration_api_v1_active_learning_service_engineering_iteration_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/active_learning_service/engineering_iteration',
    ...
    def active_learning_screening_iteration_api_v1_active_learning_service_screening_iteration_post(
        ...
        :param active_learning_screening_iteration_request: (required)
        :type active_learning_screening_iteration_request: ActiveLearningScreeningIterationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _active_learning_screening_iteration_api_v1_active_learning_service_screening_iteration_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/active_learning_service/screening_iteration',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def active_learning_screening_simulation_api_v1_active_learning_service_screening_simulation_post(
        ...
        :param active_learning_screening_simulation_request: (required)
        :type active_learning_screening_simulation_request: ActiveLearningScreeningSimulationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _active_learning_screening_simulation_api_v1_active_learning_service_screening_simulation_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/active_learning_service/screening_simulation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
