...
class ActiveLearningScreeningCampaignConfig(BaseModel):
    ...
    target_lb: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Lower bound of the target value to optimize (mode: INTERVAL)",
    )
    target_ub: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Upper bound of the target value to optimize (mode: INTERVAL)",
    )
    target_value: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Target value to optimize (mode: VALUE)"
    )
    discrete_targets: Optional[List[StrictStr]] = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.discrete_targets is None
            and "discrete_targets" in self.model_fields_set
        ):
