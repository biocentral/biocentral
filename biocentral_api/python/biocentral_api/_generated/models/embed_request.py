...
class EmbedRequest(BaseModel):
    ...
    reduce: Optional[StrictBool] = Field(
    ...
    use_half_precision: Optional[StrictBool] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "use_half_precision": obj.get("use_half_precision")
                if obj.get("use_half_precision") is not None
                else False,
            }
        )
        return _obj
