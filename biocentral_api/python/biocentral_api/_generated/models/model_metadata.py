...
class ModelMetadata(BaseModel):
    ...
    training_data_link: Optional[StrictStr] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.training_data_link is None
            and "training_data_link" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "outputs": [ModelOutput.from_dict(_item) for _item in obj["outputs"]]
