...
class GetProjectionConfigResponse(BaseModel):
    ...
    """ # noqa: E501
    projection_config: Dict[str, List[Any]] = Field(description="Projection configuration for each method")
    __properties: ClassVar[List[str]] = ["projection_config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "projection_config": obj.get("projection_config")
        })
        return _obj
