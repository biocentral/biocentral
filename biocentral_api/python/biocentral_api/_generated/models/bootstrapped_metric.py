...
class BootstrappedMetric(BaseModel):
    ...
    lower: Union[StrictFloat, StrictInt] = Field(
        description="Lower bound of the metric values"
    )
    upper: Union[StrictFloat, StrictInt] = Field(
        description="Upper bound of the metric values"
    )
    iterations: StrictInt = Field(
        description="Number of iterations used for bootstrapping"
    )
    sample_size: StrictInt = Field(description="Sample size used for bootstrapping")
    confidence_level: Union[StrictFloat, StrictInt] = Field(
        description="Confidence level used for bootstrapping"
    )
