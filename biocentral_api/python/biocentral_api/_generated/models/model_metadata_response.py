...
class ModelMetadataResponse(BaseModel):
    ...
    metadata: Annotated[List[ModelMetadata], Field(min_length=1)] = Field(
        description="List of model metadata"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "metadata": [
                    ModelMetadata.from_dict(_item) for _item in obj["metadata"]
                ]
