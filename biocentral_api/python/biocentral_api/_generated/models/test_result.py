...
class TestResult(BaseModel):
    ...
    inference_result: Optional[BiotrainerInferenceResult] = Field(
        default=None, description="Plain test inference result"
    )
    bootstrapped_metrics: Optional[List[BootstrappedMetric]] = Field(
        default=None, description="Bootstrapped test metrics"
    )
    baselines: Optional[Dict[str, List[BootstrappedMetric]]] = Field(
        default=None, description="Bootstrapped baselines by method name"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "inference_result" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.bootstrapped_metrics is None
            and "bootstrapped_metrics" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "inference_result": BiotrainerInferenceResult.from_dict(
                    obj["inference_result"]
                )
                if obj.get("inference_result") is not None
                else None,
                "bootstrapped_metrics": [
                    BootstrappedMetric.from_dict(_item)
                    for _item in obj["bootstrapped_metrics"]
                ]
                if obj.get("bootstrapped_metrics") is not None
                else None,
                "baselines": {
                    _k: [BootstrappedMetric.from_dict(_item) for _item in _v]
                    if _v is not None
                    else None
