...
class ProjectionsData(BaseModel):
    ...
    identifier: List[StrictStr]
    x: List[Union[StrictFloat, StrictInt]]
    y: List[Union[StrictFloat, StrictInt]]
    z: List[Optional[Union[StrictFloat, StrictInt]]]
    __properties: ClassVar[List[str]] = ["projection_name", "identifier", "x", "y", "z"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "projection_name": obj.get("projection_name"),
