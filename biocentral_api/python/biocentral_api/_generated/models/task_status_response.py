...
class TaskStatusResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in dtos (list)
        _items = []
        if self.dtos:
            for _item_dtos in self.dtos:
                if _item_dtos:
                    _items.append(_item_dtos.to_dict())
            _dict["dtos"] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "dtos": [TaskDTO.from_dict(_item) for _item in obj["dtos"]]
                if obj.get("dtos") is not None
                else None
            }
        )
        return _obj
