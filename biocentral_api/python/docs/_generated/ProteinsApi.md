...
with biocentral_api._generated.ApiClient(configuration) as api_client:
    ...
    try:
        # Calculate clustering
        api_response = api_instance.trigger_protein_clustering_api_v1_protein_service_cluster_post(clustering_request)
        print("The response of ProteinsApi->trigger_protein_clustering_api_v1_protein_service_cluster_post:\n")
        pprint(api_response)
    except Exception as e:
