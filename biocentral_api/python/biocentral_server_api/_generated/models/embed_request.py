...
class EmbedRequest(BaseModel):
    ...
    use_half_precision: Optional[StrictBool] = Field(default=False, description="Whether to use half precision")
    __properties: ClassVar[List[str]] = ["embedder_name", "reduce", "sequence_data", "use_half_precision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reduce": obj.get("reduce") if obj.get("reduce") is not None else False,
