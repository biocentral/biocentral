...
import '../../data/ppi_asset_dataset_container.dart';
import '../../data/ppi_client.dart';
import '../../domain/ppi_repository.dart';
import '../../model/ppi_database_test.dart';
import '../dialogs/ppi_database_tests_dialog.dart';
import '../dialogs/ppi_dataset_import_dialog.dart';
import '../dialogs/ppi_example_dataset_dialog.dart';
...
class _PPICommandViewState extends State<PPICommandView> with AutomaticKeepAliveClientMixin, TutorialRegistrationMixin {
  ...
  Widget build(BuildContext context) {
    super.build(context);
    PPICommandBloc interactionsCommandBloc = BlocProvider.of<PPICommandBloc>(context);
