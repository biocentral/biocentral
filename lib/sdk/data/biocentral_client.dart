...
final class BiocentralClientRepository {
  ...
  Future<Either<BiocentralException, Map<String, String>>> getLocalServerDownloadURLs() async {
    ...
    final String releaseFileContent = await rootBundle.loadString(serverReleasesJsonURL);
    final Map<String, String> releaseMap = stringMapFromJsonDecode(jsonDecode(releaseFileContent));
