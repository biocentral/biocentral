...
class ProtT5Conservation(BaseModel):
    ...
    def get_metadata() -> ModelMetadata:
        return ModelMetadata(
            ...
            licence='AGPL-3.0',
            outputs=[ModelOutput(name="conservation",
                                ...
                                value_type=str,
                                classes={
                                    "0": OutputClass(label="Variable", 
                                                    description="Residue is evolutionarily variable"),
                                    "1": OutputClass(label="Variable",
                                                     description="Residue is evolutionarily variable"),
                                    "2": OutputClass(label="Variable",
                                                     description="Residue is evolutionarily variable"),
                                    "3": OutputClass(label="Variable",
                                                     description="Residue is evolutionarily variable"),
                                    "4": OutputClass(label="Average",
                                                     description="Residue is equally conserved and variable"),
                                    "5": OutputClass(label="Average",
                                                     description="Residue is equally conserved and variable"),
                                    "6": OutputClass(label="Average",
                                                     description="Residue is equally conserved and variable"),
                                    "7": OutputClass(label="Variable",
                                                     description="Residue is evolutionarily conserved"),
                                    "8": OutputClass(label="Conserved",
                                                    description="Residue is evolutionarily conserved")
                                })
                    ],
            model_size='926.7 KB',
